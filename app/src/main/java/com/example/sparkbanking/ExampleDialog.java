        ...
        builder.setView(view)
                ...
                .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        myRef2.child("Rudransh Kush").child("Current Balance").addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                datacheck = dataSnapshot.getValue(String.class);
                                dtcheck = Integer.parseInt(datacheck);
                                final String name1 = edit_username.getText().toString();
                                ...
                                if (valcheck<=dtcheck){
                                    ...
                                    myRef.child("Rudransh Kush").child(id).setValue(obj);
                                    myRef.child("Rudransh Kush").child(id).child("amount").addListenerForSingleValueEvent(new ValueEventListener() {
                                        @Override
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            ...
                                                            myRef2.child("Rudransh Kush").child("Current Balance").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                ...
                                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                    ...
                                                                    data3=data3-data1;
                                                                    myRef2.child("Rudransh Kush").child("Current Balance").setValue(String.valueOf(data3));
